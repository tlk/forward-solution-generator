...
u8 input[32]={
0x4d,0x79,0x84,0xe3,0xdd,0xaf,0x93,0xd7,0x8e,0xa7,0x6f,0x8c,0xa0,0xc1,0x46,0x5f,
0xdb,0x60,0x65,0x01,0x6b,0x19,0xe9,0xd2,0xce,0xff,0x50,0xad,0xca,0x9c,0x85,0xd4
};
...
{
    u8 output[32];
    Forward(input, output, sbox, pbox);
    printf("%s\n", output);
    return 0;
}
