...
class TestNForwardUnrolled(unittest.TestCase):
    def test_forward(self):
        inp = test_data1
        out = "Reverse me fast\0"
        res = nforward_unrolled.forward(inp)
    ...
    def test_substitute(self):
        ...
        res = nforward_unrolled.substitute(inp)
        self.assertEqual(out, res)
